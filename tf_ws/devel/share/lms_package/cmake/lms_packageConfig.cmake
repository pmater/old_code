...
if(NOT "/home/calvon/tf_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lms_package' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/calvon/tf_ws/src/lms_package/${idir}'.  Ask the maintainer 'calvon <calvon@todo.todo>' to fix it.")
    endif()
