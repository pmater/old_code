...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sync_package' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/calvon/tf_ws/src/sync_package/${idir}'.  Ask the maintainer 'calvon <calvon@todo.todo>' to fix it.")
    endif()
